...
El detalle de cada compra debe almacenar el precio unitario aplicado al momento de realizar la
...
Cada compra debe utilizar un único método de pago, que deberá corresponder a alguno de los medios admitidos por el sistema: tarjeta de débito, tarjeta de crédito o transferencia.
